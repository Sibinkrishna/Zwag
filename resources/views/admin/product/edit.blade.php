                         ...
                         <div class="col-xl-3 col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="mt-3">
                                             <h4>{{$product->product_name}}<span class="fs-14 text-muted ms-1">({{$product->product_varient->first()->tag}})</span></h4>
                                             <h5 class="text-dark fw-medium mt-3">Price :</h5>
                                             <h4 class="fw-semibold text-dark mt-2 d-flex align-items-center gap-2">
                                                  <span class="text-muted text-decoration-line-through">{{ ProductConstants::RUPEES_SYMBOL['INDIAN'] }} {{$product->product_varient->first()->price}}</span>{{ ProductConstants::RUPEES_SYMBOL['INDIAN'] }} {{$product->product_varient->first()->selling_price}} 
                                                  <!-- <small class="text-muted"> (30% Off)</small> -->
                                             </h4>
                                             <div class="mt-3">
                                                  <h5 class="text-dark fw-medium">Size :</h5>
                                                  <div class="d-flex flex-wrap gap-2" role="group" aria-label="Basic checkbox toggle button group">
                                                       <!-- <label class="btn btn-light avatar-sm rounded d-flex justify-content-center align-items-center" for="size-s">{{ json_decode($product->product_varient->first()->product_associate)}}</label> -->
                                                  </div>
                                             </div>
                                             <div class="mt-3">
                                             ...
                                             <div class="col-lg-6">
                                                  <form>
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="text" id="product-name" class="form-control" placeholder="Items Name" value="{{ $product->product_name }}">
                                                       </div>
                                                  </form>
                                             </div>
                                             <div class="col-lg-6">
                                             ...
                                             <div class="col-lg-4">
                                                  <form>
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="text" id="product-weight" class="form-control" placeholder="In gm & kg" value="{{ $product->weight }}">
                                                       </div>
                                                  </form>
                                             </div>
                                             <div class="col-lg-4">
                                                  <form>
                                                       ...
                                                       <select class="form-control" id="gender" data-choices data-choices-groups data-placeholder="Select Gender"
                                                            ...
                                                            @foreach(ProductConstants::GENDER as $key => $label)
                                                                 <option value="{{ $key }}" selected aria-readonly="true">{{ $label }}</option>
                                                            @endforeach
                                                       </select>
                                                  </form>
                                             </div>
