                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="sub-category-name" name="sub_category_name" class="form-control"
                                    ...
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="category_status"
                                                id="flexRadioDefault1"  {{ old('category_status') == 1 ? 'checked' : '' }} value="1">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="category_status"
                                                id="flexRadioDefault2"  {{ old('category_status') == 0 ? 'checked' : '' }} value="0">
